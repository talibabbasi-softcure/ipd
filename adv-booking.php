<?php
	...
	if($ipdId){
		$_SESSION['msg']="No-Msg";
		$sql_ipd= mysql_query_db("select * from health_ipd where ipdId='$ipdId'");
		...
		$garDetails= mysql_query_db("select * from health_guardian_details where patientId='".$line_ipd['patientId']."'");
		$fgardetails= mysql_fetch_db($garDetails);
		$commnt= mysql_query_db("select * from health_medico_detail where ipdId='$ipdId'");
		$fcommnt= mysql_fetch_db($commnt);
		$alloc55= mysql_query_db("select * from health_allocation where ipdId='$ipdId'");
		$falloc55= mysql_fetch_db($alloc55);
		$room55= mysql_query_db("select * from health_roomalias where id='".$falloc55['roomNo']."'");
		$froom55= mysql_fetch_db($room55);
		$filechrg= mysql_query_db("select * from health_ipdFileCharge where ipdId='$ipdId'");
		$ffilechrg= mysql_fetch_db($filechrg);
		$finnace= mysql_query_db("select * from health_financeipd where ipdId='$ipdId'");
		$ffinnace= mysql_fetch_db($finnace);
    ...
    <head>
        ...
        <script>
            ...
            function _doctorFee(val95)
            {
                ...
                xend = url.lastIndexOf("/") + 1;
                var base_url = url.substring(0, xend);
                url="../allajax/doctorIpdFee-ajax.php";
				if (url.substring(0, 4) != 'http') 
				{
					url = base_url + url;		
				}
			...
			function _mobileload(val95)
			{
				...
				xend = url.lastIndexOf("/") + 1;
				var base_url = url.substring(0, xend);
				url="../allajax/findpatientipd.php";
				if (url.substring(0, 4) != 'http') 
				{
					url = base_url + url;		
				}
        ...
        <?php if(($_SESSION['sess_ipd_msg']==1)&&($_SESSION['sess_ipd_msg']!='')){?>
			<script>
                //alert("Registration Successful");
			</script>
			<?php } else if($_SESSION['sess_ipd_msg']==2) {?>
			<script>
                //alert("Updated Successfully");
			</script>
		<?php } $_SESSION['sess_ipd_msg']=0;?>
		<style>
			#loader1{
            ...
            <div class="full">
                <div class="mauto95">
					...
					<div class="full grey_bck22 box_shadow66"><!--full80r-->
						<div class="full line_hgt35 yellow_bck2">  <!--right_side_head-->
							<div class="mauto95">
								<div class="full">
									<div class="full33 black18">Advance IPD Booking </div>
									<div class="full33">
										<div  class="full white14 line_hgt32 txt_center" style="display:;background-color: #356EB9; padding: 2px; font-size:12px;">
											<?php 
                        ...
                        <div class="mauto95">
                            <div class="full">
								...
								<form name="add_invoice" id="add_invoice" method="post" action="ipd-advance-registration-code.php" enctype="multipart/form-data">
									...
									<div class="full">
										<div class="full40">
											<div class="full">
												<div class="full85 line_hgt25 white14 yellow_bck padd_left10">
													<div class="full50">
														Patient Details
													</div>
													<div class="full20r">
														Booking <a href="adv-booking.php"><img src="../images/booking.png" height="20px"></a>
													</div>
												</div>
												<div class="clearfix10"></div>    
												<div class="full">
													<div class="full25 grey14 line_hgt25">Mobile</div>
													<div class="full5 txt_center line_hgt25"> : </div>
													<div class="full65">
														<div class="full">
															<div class="full65"><input type="text" name="mobileNumber" id="mobileNumber" value="<?php if($line['mobileNumber']){ echo ucwords($line['mobileNumber']);}?>" required  title="Please Enter Mobile" placeholder="Mobile Number" maxlength="10" onkeypress="return _isNumberKey(event)" class="dash_txt_box75 padd_left10" onKeyUp="_mobileload(this.value)">
															</div>
															<!--<div class="full45"><input type="text" name="alterMobileNumber" id="alterMobileNumber" value="<?php //if($line['alterMobileNumber']){ echo ucwords($line['alterMobileNumber']);}?>" placeholder="Alternate Number" maxlength="15" onkeypress="return _isNumberKey(event)" class="dash_txt_box75 padd_left10"></div>
											...
											<div class="clearfix10"></div>
											<div class="full">
												<div class="full25 grey14 line_hgt25"> Department </div>
												<div class="full5 txt_center line_hgt25"> : </div>
												<div class="full70">
													<div class="full">
														<select name="departmentId" class="select_txt82 grey14" id="departmentId" required  title="Please Select Department" onChange="_doctorAjax(this.value)">
											...
											<div class="clearfix10"></div>
											<div class="full">
												<div class="full25 grey14 line_hgt25">Consulting Doctor </div>
												<div class="full5 txt_center line_hgt25"> : </div>
												<div class="full70">
													<div class="full">
														<div class="full" id="doctorIdAjax">
															<select name="doctorId" class="select_txt82 grey14" id="doctorId" required  title="Please Select Doctor Name" onChange="_doctorFee(this.value)">
											...
											<div class="full">
												...
												<div class="full5 txt_center line_hgt25"> : </div>
												<div class="full70">
													<!--<input onkeyup="pulsar(this)"  type="text" name="refDoc" id="refDoc" value="<?php if($line_ipd['refDoc']){ echo ucwords($line_ipd['refDoc']);}?>" maxlength="40" placeholder="Referral Name"  title="Please Referral Name" class="select_txt82">-->
													<div class="full">
														<select name="reffDoctorId" class="select_txt82 grey14" id="reffDoctorId">
											...
											<div class="clearfix10"></div>
											<div class="full">
												<div class="full25 grey14 line_hgt25"> Patient's Name </div>
												<div class="full5 txt_center line_hgt25"> : </div>
												<div class="full70">
													<div class="full">
														<div class="full25">
														...
														<div class="full70">
															<div class="full">
																<input onkeyup="pulsar(this)"  type="text" name="patientName" id="patientName" value="<?php if($line['patientName']){ echo ucwords($line['patientName']);}?>" maxlength="40" placeholder="Patient's Name" required  title="Please Enter Patient Name" class="dash_txt_box83" <?php if(isset($Id)){ echo "readonly";}?>  <?php if(isset($Id)){echo "style='background-color:grey;color:#fff;'";}?>  >
															</div>
											...
											<div class="clearfix10"></div>
											<div class="full">
												<div class="full25 grey14 line_hgt25"> S/o/D/o/W/o Name </div>
												<div class="full5 txt_center line_hgt25"> : </div>
												<div class="full70">
													<div class="full">
														<div class="full25">
														...
														<div class="full70">
															<div class="full">
																<input onkeyup="pulsar(this)"  type="text" name="fatherHusName" id="fatherHusName" value="<?php if($line['fatherHusName']){ echo ucwords($line['fatherHusName']);}?>" maxlength="40" placeholder="Father/Husband's Name" required  title="Please Enter Father Name" class="dash_txt_box83" <?php if(isset($Id)){ echo "readonly";}?>  <?php if(isset($Id)){echo "style='background-color:grey;color:#fff;'";}?>  >
															</div>
											...
											<div class="full">
												<div class="full">
													<div class="full">
														<div class="full25 grey14 line_hgt25">Age/Gender/Marital</div>
														<div class="full5 txt_center line_hgt25"> : </div>
														<div class="full70">
															<div class="full">
																<div class="full">
																	<input type="text" name="age" id="age" value="<?php if($line['age']){ echo ucwords($line['age']);}?>" required  title="Please Enter Age" placeholder="Age" maxlength="5" onkeypress="rreturn _isNumberKey(event)" class="post_ad_txt70 padd_left10">
											...
											<div class="clearfix10"></div>
											<div class="full">
												<div class="full25 grey14 line_hgt25"> Address </div>
												<div class="full5 txt_center line_hgt25"> : </div>
												<div class="full65">
													<div class="full">
														<textarea onkeyup="pulsar(this)"  name="address" id="address" required placeholder="Patient Address" title="Please Enter Address" maxlength="150" class="txt_area_add"><?php if($line['address']){ echo ucwords($line['address']);}?></textarea>
													</div>
												</div>
											</div>
											<div class="full" style="display:none;">
												...
												<div class="full65">
													<div class="full">
														<div class="full">
															<select name="stateId" class="select_txt82 grey14" id="stateId" title="Please Select State" onchange="_cityAjax(this.value)">
												...
												<div class="full65">
													<div class="full">
														<div class="full" id="city-id55">
															<select name="cityId" class="select_txt82 grey14" id="cityId"  title="Please Select City">
											...
											<div class="full">
												...
												<div class="full65">
													<div class="full50">
														<div class="full"><input type="text" name="patientZipcode" id="patientZipcode" value="<?php echo $line['patientZipcode'];?>"  title="Please Enter Zip Code" placeholder="Pin Code" maxlength="6" onkeypress="return _isNumberKey(event)" class="dash_txt_box79 padd_left10"></div>
													...
													<div class="full50">
														...
														<div class="full5 txt_center line_hgt25"> : </div>
														<div class="full50">
															<select name="bloodGroup" id="bloodGroup" required title="Please Select Blood Group" class="select_txt71">
										...
										<div class="full40">
											<div class="full85 line_hgt25 white14 yellow_bck padd_left10">Payer Details</div>
											<div class="clearfix10"></div>
											<div class="full">
												<div class="full25 grey14 line_hgt25">Payer Name</div>
												<div class="full5 txt_center line_hgt25 grey14"> : </div>
												<div class="full65">
													<select name="payer" class="select_txt82 grey14" id="payer"   title="Please Select Payer">
														<?php
											...
											<div class="full">
												...
												<div class="full65">
													<div class="full65">
														<div class="full"><input type="text" name="rank" id="rank" value="<?php echo $line['custom3'];?>" placeholder="Rank" maxlength="500" class="dash_txt_box75 padd_left10"></div>
														<!--<div class="msg_div" id="phoneNumber_validate"></div>-->
													</div>
												</div>
											</div>
											...
											<div class="clearfix10"></div>
											<div class="full85 line_hgt25 white14 yellow_bck padd_left10">Payment Details</div>
											<div class="clearfix10"></div>
											<div class="full">
												<div class="full">
													<div class="full25 grey14 line_hgt25"> Amount </div>
													<div class="full5 txt_center line_hgt25"> : </div>
													<div class="full65 grey14 line_hgt25">
														<div class="full65">
                                                            <input type="text" name="creditAmount" id="creditAmount" placeholder="Amount" required value="" maxlength="7" onkeypress="return _isNumberKey(event)" class="dash_txt_box">
														</div>
													</div>
												</div>
												<div class="clearfix10"></div>
												<div class="full">
													...
													<div class="full25 grey14 line_hgt25"> Payment Mode </div>
													<div class="full5 txt_center line_hgt25"> : </div>
													<div class="full65 grey14 line_hgt25">
														<div class="full65">
															<select name="paymentMode" class="select_txt83 grey14" id="paymentMode" required  onchange="_showBank(this.value)">
																<?php
																	$modeOfPayment22=count($modeOfPayment);
																	for($i=1;$i<$modeOfPayment22;$i++){
																		if($i==4){continue;}
																	?>
																	<option value="<?php echo $modeOfPayment[$i];?>"<?php if($ffinnace['paymentMode']==$modeOfPayment[$i]){ echo "selected";}?>><?php echo $modeOfPayment[$i];?></option>
																<?php }?>
															</select>
														</div>
													</div>
												...
												<div class="full">
													<div class="clearfix10"></div>
													<div class="full" id="bnk" style=" <?php if($ffinnace['paymentMode']!='By Cheque'){?>display:none;<?php }?>">
														<input type="hidden" name="bnk22" id="bnk22" value="">
														<div class="full">
															<div class="full25 grey14 line_hgt28"> Bank </div>
															<div class="full5 txt_center line_hgt28"> : </div>
															<div class="full65 grey14 line_hgt25">
																<div class="full65">
																	<input type="text" name="bankName" id="bankName" placeholder="Bank Name" value="<?php echo strtoupper($ffinnace['bankName']);?>" maxlength="50" class="dash_txt_box" onkeyup="pulsar(this)">
																</div>
															</div>
														</div>
														<div class="clearfix10"></div>
														<div class="full">
															<div class="full25 grey14 line_hgt28"> Cheque No </div>
															<div class="full5 txt_center line_hgt28"> : </div>
															<div class="full65 grey14 line_hgt25">
																<div class="full65">
																	<input type="text" name="chequeNo" id="chequeNo" placeholder="Cheque No" value="<?php echo strtoupper($ffinnace['chequeNo']);?>" maxlength="10" onkeypress="return _isNumberKey(event)" class="dash_txt_box">
																</div>
															</div>
														</div>
													</div>
													<div class="full" id="online" style=" <?php if($ffinnace['paymentMode']!='Online'){?>display:none;<?php }?>">
														<input type="hidden" name="bnk22" id="bnk22" value="">
														<div class="full">
															<div class="full25 grey14 line_hgt28"> Transaction ID </div>
															<div class="full5 txt_center line_hgt28"> : </div>
															<div class="full65 grey14 line_hgt25">
																<div class="full65">
																	<input type="text" name="transactionId" id="transactionId" placeholder="Transaction ID" value="<?php echo strtoupper($ffinnace['transactionId']);?>" maxlength="50" class="dash_txt_box">
																</div>
															</div>
														</div>
														<div class="clearfix10"></div>
														<div class="full">
															<div class="full25 grey14 line_hgt28"> Particular </div>
															<div class="full5 txt_center line_hgt28"> : </div>
															<div class="full65 grey14 line_hgt25">
																<div class="full65">
																	<input type="text" name="particular" id="particular" placeholder="Particular" value="<?php echo strtoupper($ffinnace['particular']);?>" maxlength="100" class="dash_txt_box" onkeyup="pulsar(this)">
																</div>
															</div>
														</div>
													</div>
										...
										<div class="full20">
											<div class="full pink_bck">
												<div class="mauto95">
													<div class="full30 white14 line_hgt25">Arrival Date</div>
													<div class="full5 txt_center line_hgt25 white14"> : </div>
													<div class="full65">
														<?php $editdate="datepicker"; ?>
														<input type="text" name="ipd_cur_date" id="<?php if($ipdId==''){echo $editdate;} ?>" value="<?php if($line_ipd['dateTime']){ echo $line_ipd['dateTime']; }else{echo $today;} ?>" placeholder="Select Date" required class="dash_txt_box" style="width:148px; height:22px; ">
													</div>
												</div>
											</div>
											<div class="clearfix10"></div>
																...
																<div class="full">													<!--onchange="_roomBedSelect(this.value), _roomNoAjax(this.value, '<?php //echo $allpat;?>', '<?php //echo $roomcateg;?>')">-->
																	<select name="categoryAllocation" class="select_txt grey14" id="category">
																		...
																		<?php
																			...
																			?>
																			<option value="<?php echo $froomcat['roomCategoryId'];?>"<?php if($falloc55['category']==$froomcat['roomCategoryId']){ echo "selected";}?>><?php echo $froomcat['roomCategoryName'];?></option>
																		<?php }?>
																	</select>
																</div>
															</div>
														...
														<div class="full65">
															<div class="full">
																<div class="full" id="ttlRoom">
																	<select name="roomNo" class="select_txt grey14" id="roomNo" title="Please Select Room No">
											...
											<div class="full line_hgt25 grey14 padd_left10">
												...
												<div class="full5 txt_center line_hgt25"> : </div>
												<div class="full65">
													<select name="patientNationality" id="patientNationality" required class="select_txt">
											...
											<div class="full grey14 line_hgt25 txt_right">
												<input type="submit" name="submit" value=" <?php if($ipdId!=''){?>Update<?php } else {?>Register<?php }?>" class="dash_btn" id="submit_btn"> <!--&nbsp;
												<input type="submit" name="submit" value="Print" class="dash_btn">-->
											</div>
										</div>
									</div>
								</form>		   
